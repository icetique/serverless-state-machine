...
import { createHandler, createPublisher, getBatchSize } from '../../outbox-dispatcher';
import { EventPublisher } from '../../src/publisher';
import { OutboxRepository } from '../../src/outbox-repository';

const publisherModule = jest.requireActual('../../src/publisher') as typeof import('../../src/publisher');
